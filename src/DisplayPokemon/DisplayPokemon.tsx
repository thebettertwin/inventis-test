    ...
    return <>
        {pokemonData.map(pokemon => {
            return (
                ...
                >
                    <figure className=
                        "group flex flex-col items-center p-5 text-center rounded-2xl bg-white/10 hover:ring-2 hover:cursor-pointer hover:bg-white/90 ring-orange-600 transition-all duration-500 opacity-70 hover:opacity-100"
                        key={pokemon.id}>
